...
% With respect to this trend, we urge developers to consider the cautionary words of Dr. Ian Malcolm: to not be so preoccupied with whether or not you can, that you do not stop to think whether you should~\cite{crichton1991jurassic}. 
...
% THEREFORE
% Therefore therefore it is better to be explicit than implicit
