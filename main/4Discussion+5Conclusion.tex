...
\subsubsection{The Malcolm principle}
...
with this in mind, we remind AI developers of the criticism of Dr. Ian Malcolm: do not be so preoccupied with whether or not you can that you do not stop to think whether you should.
...
decisions about the content and modality of information communicated with the user should be a first class citizen in AI design
...
xAI to be designed with a strong emphasis on the social and cognitive aspects of user interaction, with user feedback taken through this lens
