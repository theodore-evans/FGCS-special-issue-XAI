...
\newcommand{\researchquestions}{
    \begin{enumerate}[wide]
        \item How are prominent approaches from the state of the art in xAI interpreted and evaluated by expert users in a representative diagnostic setting?
        \item How do these interpretations and evaluations inform strategies for safe and effective xAI development?
    \end{itemize}
}
